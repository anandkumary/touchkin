...
#define kPhotoEditorViewControllerInnerEdgeInset 15.0


@interface YLImageEditorVC ()
...
@property (nonatomic, retain) UIView *circleOverlayView;
...
@implementation YLImageEditorVC
...
- (void)initView {
    ...
    _overlayType = YLImageEditiorCircleOverlay;
    if(_overlayType != YLImageEditiorSquareOverlay)
    {
        self.ratioView.layer.borderWidth = 0.0f;
        
        [self overlayCircleClipping];
    }
    else{
...
- (void)cancel:(id)sender {
    ...
    if(self.delegate && [self.delegate conformsToProtocol:@protocol(YLImageEditorVCDelegate)]){
...
#pragma mark - Square OverLay

- (void)overlayCircleClipping
{
    ...
    [fillLayer setFillRule:kCAFillRuleEvenOdd];
    [fillLayer setFillColor:[UIColor blackColor].CGColor];
    [fillLayer setOpacity:0.8];
