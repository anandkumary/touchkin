...
static const NSInteger kDefaultCacheMaxCacheAge = 60 * 60 * 24 * 365; // 1 week
    ...
    if ((self = [super init])) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(clearMemory)
                                                   ...
                                                   object:nil];
        // Commented because we will be use=ing this one from document directory later part//
//        [[NSNotificationCenter defaultCenter] addObserver:self
...
- (NSOperation *)queryDiskCacheForKey:(NSString *)key done:(void (^)(UIImage *image, SDImageCacheType cacheType))doneBlock {
    ...
    dispatch_async(self.ioQueue, ^{
        ...
        @autoreleasepool {
            ...
            if (self.customDiskCachePath) {
                self.diskCachePath = self.customDiskCachePath;
            }
